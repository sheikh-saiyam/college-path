  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-5xl text-center relative z-10">
        ...
        >
          <Badge className="mb-4 bg-gradient-to-r from-bg-violet to-bg-pink text-white border-0 px-6 py-2 text-sm font-medium">
            <GraduationCap size={35} className="h-10 w-10" /> Discover Your
            Dream College
          </Badge>
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-extrabold mb-2 bg-gradient-to-r from-bg-violet to-bg-pink bg-clip-text text-transparent leading-tight"
        >
        ...
        <motion.p
          ...
          className="text-xl text-[#6b6e7e] mb-8 max-w-2xl mx-auto leading-relaxed"
        >
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row gap-2 items-center max-w-md mx-auto mb-6"
        >
          <Input
            type="text"
          ...
          <Button
            ...
            className="h-11 px-8 bg-gradient-to-r from-bg-violet to-bg-pink hover:from-bg-violet/90 hover:to-bg-pink/90 duration-300 cursor-pointer text-white rounded-full font-medium"
          >
